...
resourcename="tropicalwildlifemgmt"  # lower case, only
resourcegroup="tropicalwildlifemgmt_rg"
...
# git clone https://github.com/apilogicserver/tropicalwildlifemgmt.git
# cd tropicalwildlifemgmt
...
az group create --name tropicalwildlifemgmt_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group tropicalwildlifemgmt_rg --sku S1 --is-linux
az container create --resource-group tropicalwildlifemgmt_rg --name tropicalwildlifemgmt --image apilogicserver/tropicalwildlifemgmt:latest --dns-name-label tropicalwildlifemgmt --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//tropicalwildlifemgmt.westus.azurecontainer.io:5656'
