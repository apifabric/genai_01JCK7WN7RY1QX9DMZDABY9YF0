...
@Component({
  selector: 'IllegalActivity-home',
  templateUrl: './IllegalActivity-home.component.html',
  styleUrls: ['./IllegalActivity-home.component.scss']
})
export class IllegalActivityHomeComponent implements AfterViewInit {
