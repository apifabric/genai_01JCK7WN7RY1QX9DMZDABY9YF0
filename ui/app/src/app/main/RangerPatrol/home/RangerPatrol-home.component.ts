...
@Component({
  selector: 'RangerPatrol-home',
  templateUrl: './RangerPatrol-home.component.html',
  styleUrls: ['./RangerPatrol-home.component.scss']
})
export class RangerPatrolHomeComponent implements AfterViewInit {
