...
@Component({
  selector: 'Ranger-home',
  templateUrl: './Ranger-home.component.html',
  styleUrls: ['./Ranger-home.component.scss']
})
export class RangerHomeComponent implements AfterViewInit {
