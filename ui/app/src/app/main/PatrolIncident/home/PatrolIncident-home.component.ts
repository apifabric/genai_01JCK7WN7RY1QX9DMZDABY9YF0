...
@Component({
  selector: 'PatrolIncident-home',
  templateUrl: './PatrolIncident-home.component.html',
  styleUrls: ['./PatrolIncident-home.component.scss']
})
export class PatrolIncidentHomeComponent implements AfterViewInit {
