...
@Component({
  selector: 'ResearcherStudyLink-home',
  templateUrl: './ResearcherStudyLink-home.component.html',
  styleUrls: ['./ResearcherStudyLink-home.component.scss']
})
export class ResearcherStudyLinkHomeComponent implements AfterViewInit {
