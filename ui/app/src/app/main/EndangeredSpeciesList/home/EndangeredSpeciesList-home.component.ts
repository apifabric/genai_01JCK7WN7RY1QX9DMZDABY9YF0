...
@Component({
  selector: 'EndangeredSpeciesList-home',
  templateUrl: './EndangeredSpeciesList-home.component.html',
  styleUrls: ['./EndangeredSpeciesList-home.component.scss']
})
export class EndangeredSpeciesListHomeComponent implements AfterViewInit {
