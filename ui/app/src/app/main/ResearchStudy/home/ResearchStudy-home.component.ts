...
@Component({
  selector: 'ResearchStudy-home',
  templateUrl: './ResearchStudy-home.component.html',
  styleUrls: ['./ResearchStudy-home.component.scss']
})
export class ResearchStudyHomeComponent implements AfterViewInit {
