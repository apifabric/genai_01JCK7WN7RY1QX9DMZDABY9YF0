...
@Component({
  selector: 'ConservationProject-home',
  templateUrl: './ConservationProject-home.component.html',
  styleUrls: ['./ConservationProject-home.component.scss']
})
export class ConservationProjectHomeComponent implements AfterViewInit {
